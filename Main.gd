...
func _ready() -> void:
	#Request.request(self,"https://pastebin.com/raw/WFxTHwrP")
	#call_deferred("MeshGen.generate_custom_geometry",MeshGen.TRIANGLE_TYPE_BOTTOM_LEFT)
	#call_deferred("MeshGen.generate_custom_geometry(MeshGen.TRIANGLE_TYPE_TOP_RIGHT)")
